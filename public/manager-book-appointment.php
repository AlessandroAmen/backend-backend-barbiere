...
if (!$data || !isset($data['barber_id']) || !isset($data['date']) || !isset($data['time']) || !isset($data['service_type']) || !isset($data['client_name'])) {
...
try {
    ...
    $appointment->notes = $data['notes'] ?? 'Prenotazione effettuata dal gestore';
    $appointment->status = 'confirmed'; // Prenotazioni dai gestori sono automaticamente confermate
